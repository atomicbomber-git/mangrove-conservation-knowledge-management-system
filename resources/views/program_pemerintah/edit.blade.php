...
@section('title', 'Sunting Program Pemerintah')
@section('content')
            ...
            <form method='POST' action='{{ route('program-pemerintah.update', $programPemerintah) }}'>
                ...
                <div class='form-group'>
                    ...
                    <input
                        ...
                        placeholder='Nama'
                        value='{{ old('nama', $programPemerintah->nama) }}'
                    ...
                    <div class="col-md">
                        <div class='form-group'>
                            ...
                            <input
                                ...
                                value='{{ old('tanggal_mulai', $programPemerintah->tanggal_mulai) }}'
                    ...
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value='{{ old('tanggal_selesai', $programPemerintah->tanggal_selesai) }}'
                ...
                <div class='form-group'>
                    ...
                    <input
                        ...
                        placeholder='Dana'
                        value='{{ old('dana', $programPemerintah->dana) }}'
                ...
                <div class='form-group'>
                    ...
                    <input
                        ...
                        value='{{ old('penanggung_jawab', $programPemerintah->penanggung_jawab) }}'
                ...
                <div class='form-group'>
                    ...
                    <input
                        ...
                        value='{{ old('nama_instansi', $programPemerintah->nama_instansi) }}'
                ...
                <div class='form-group'>
                    ...
                    <input
                        ...
                        value='{{ old('nama_instansi_penerima', $programPemerintah->nama_instansi_penerima) }}'
                ...
                <div class='form-group'>
                    ...
                    <input
                        ...
                        value='{{ old('penanggung_jawab_penerima', $programPemerintah->penanggung_jawab_penerima) }}'
                ...
                <div class='form-group'>
                    ...
                    <textarea
                        ...
                        col='30' row='6'
                        >{{ old('bentuk', $programPemerintah->bentuk) }}</textarea>
                ...
                <div class='form-group'>
                    ...
                    <textarea
                        ...
                        col='30' row='6'
                        >{{ old('hasil', $programPemerintah->hasil) }}</textarea>
                ...
                <div class='form-group'>
                    ...
                    <input
                        ...
                        step="0.01"
                        value='{{ old('persentase_hasil', $programPemerintah->persentase_hasil) }}'
                ...
                <div>
                    <input id="submit" type="submit" value="Perbarui Program Pemerintah" class="btn btn-primary">
                </div>
            </form>
        </div>
    </div>
